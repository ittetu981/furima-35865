...
RSpec.describe Item, type: :model do
  ...
  context '出品できるとき' do
    it 'product_nameとdescription_of_itemとcategory_id、delivery_charge_idとproduct_status_id、shipment_source_idとprice、shipping_charge_idが存在すれば出品できること' do
  ...
  context '出品できないとき' do
    ...
    it '販売価格は半角数字以外では出品できないこと' do
      @item.price = '1111111'
      @item.valid?
      expect(@item.errors.full_messages).to include("Price can only be displayed in single-byte numbers ")
