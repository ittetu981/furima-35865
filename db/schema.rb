...
ActiveRecord::Schema.define(version: 2021_06_28_132229) do
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "full_width_surname", null: false
    t.string "surname_yomigana", null: false
    t.string "full_width_name", null: false
    t.string "name_yomigana", null: false
